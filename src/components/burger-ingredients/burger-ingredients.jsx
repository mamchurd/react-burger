    ...
    return(
        <section className={styles.section}>
            ...
            <div className={styles.list}  onScroll={handleScroll}>
                <div ref={bunGroupRef}> <IngredientsGroup name='Булки' data={buns} /> </div> 
                <div ref={sauceGroupRef}> <IngredientsGroup name='Соусы' data={sauces} /> </div>
                <div ref={mainGroupRef}> <IngredientsGroup name='Начинки' data={mains} /> </div>
            </div>
            {selectedItem && 
